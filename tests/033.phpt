...
$inidir = __DIR__ . DIRECTORY_SEPARATOR . "inis" . DIRECTORY_SEPARATOR . "033";
...
bool(true)
<br />
<b>Warning</b>:  yaconf: YAML config '%s/inis/033/app.yaml' must have a mapping root in <b>Unknown</b> on line <b>0</b><br />
string(6) "scalar"
bool(true)
<br />
